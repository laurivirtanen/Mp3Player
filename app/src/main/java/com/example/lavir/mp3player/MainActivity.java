package com.example.lavir.mp3player;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parennt, View view, int position, long id) {
                try {
                    mediaPlayer.reset();
    ...
    private class LoadSongsTask extends AsyncTask<Void, String, Void> {
        ...
        protected void onPostExecute(Void args) {
            ArrayAdapter<String> songList =
                    new ArrayAdapter<>(MainActivity.this, android.R.layout.simple_list_item_1, loadedSongs);
